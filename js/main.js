...
(function(window) {
  ...
  FragmentsFx.prototype.options = {
    // Number of fragments.
    fragments: 25, // The boundaries of the fragment translation (pixel values).
    boundaries: {
      x1: 100,
      x2: 100,
      y1: 50,
    ...
    parallax: false, // Range of movement for the parallax effect (pixel values).
    randomParallax: {
      min: 10,
      max: 150
    }
    ...
    if (this.options.parallax) {
      this.mousemoveFn = function(ev) {
        requestAnimationFrame(function() {
          ...
          const mousepos = getMousePos(ev), // Document scrolls.
            docScrolls = {
              left: document.body.scrollLeft + document.documentElement.scrollLeft,
              top: document.body.scrollTop + document.documentElement.scrollTop
            },
            bounds = self.el.getBoundingClientRect(), // Mouse position relative to the main element (this.el).
            relmousepos = {
